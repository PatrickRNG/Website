...
- [Adding a script to start both Electron and React simultanesly](#adding-a-script-to-start-both-electron-and-react-simultanesly)
...
## Adding a script to start both Electron and React simultanesly
